...
use Swac\Example\FooBarOAS3\Lie\Definitions\LiesLie;
use Swac\Example\FooBarOAS3\Lie\Request\GetLiesIdRequest;
 ...
 * HTTP: GET /lies/{id}
 */
class GetLiesId extends AbstractOperation
{
    /**
     * @param ClientInterface $client
     * @param GetLiesIdRequest $request
     * @param Config $config
     * @throws InvalidValue
     * @throws RestException
     */
    public function __construct(ClientInterface $client, GetLiesIdRequest $request, Config $config)
    {
        $this->client = $client;
        $request->validate();
    ...
    /**
     * @return LiesLie|RestErrResponse
     * @throws RestException
     * @throws InvalidValue
     * @throws Exception
    ...
    public function getResponse()
    {
        ...
        switch ($statusCode) {
            case StatusCode::OK: $result = LiesLie::import($this->getJsonResponse());break;
