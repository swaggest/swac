...
// FindPetsRequest is operation request value.
...
func (request *FindPetsRequest) encode(ctx context.Context, baseURL string) (*http.Request, error) {
...
func (result *FindPetsResponse) decode(resp *http.Response) error {
	var err error
...
// FindPets performs REST operation.
func (c *Client) FindPets(ctx context.Context, request FindPetsRequest) (result FindPetsResponse, err error) {
