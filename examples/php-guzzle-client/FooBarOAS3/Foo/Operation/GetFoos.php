...
use Swac\Example\FooBarOAS3\Foo\Request\GetFoosRequest;
use Swac\Example\FooBarOAS3\Foo\Response\GetFoosOKResponse;
...
class GetFoos extends AbstractOperation
{
    ...
    /**
     * @return UsecaseFooInfo[]|array|RestErrResponse
     * @throws RestException
     * @throws InvalidValue
     * @throws Exception
    ...
    public function getResponse()
    {
        ...
        switch ($statusCode) {
            case StatusCode::OK: $result = GetFoosOKResponse::import($this->getJsonResponse());break;
