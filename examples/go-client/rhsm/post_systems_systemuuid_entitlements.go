...
// PostSystemsSystemUUIDEntitlementsRequest is operation request value.
type PostSystemsSystemUUIDEntitlementsRequest struct {
...
func (request *PostSystemsSystemUUIDEntitlementsRequest) encode(ctx context.Context, baseURL string) (*http.Request, error) {
	requestURI := baseURL + "/systems/" + url.PathEscape(request.SystemUUID) + "/entitlements"
...
// PostSystemsSystemUUIDEntitlementsResponse is operation response value.
type PostSystemsSystemUUIDEntitlementsResponse struct {
	StatusCode               int
	RawBody                  []byte                                             // RawBody contains read bytes of response body.
	ValueOK                  *PostSystemsSystemUUIDEntitlementsResponseValueOK  // ValueOK is a value of 200 OK response.
...
func (result *PostSystemsSystemUUIDEntitlementsResponse) decode(resp *http.Response) error {
	var err error
	...
	case http.StatusOK:
		...
		if err != nil {
			err = fmt.Errorf("failed to decode 'post /systems/{SystemUUID}/entitlements' OK response: %w", err)
		}
	case http.StatusBadRequest:
		err = json.NewDecoder(body).Decode(&result.ValueBadRequest)
		if err != nil {
			err = fmt.Errorf("failed to decode 'post /systems/{SystemUUID}/entitlements' BadRequest response: %w", err)
		}
	case http.StatusUnauthorized:
		err = json.NewDecoder(body).Decode(&result.ValueUnauthorized)
		if err != nil {
			err = fmt.Errorf("failed to decode 'post /systems/{SystemUUID}/entitlements' Unauthorized response: %w", err)
		}
	case http.StatusForbidden:
		err = json.NewDecoder(body).Decode(&result.ValueForbidden)
		if err != nil {
			err = fmt.Errorf("failed to decode 'post /systems/{SystemUUID}/entitlements' Forbidden response: %w", err)
		}
	case http.StatusNotFound:
		err = json.NewDecoder(body).Decode(&result.ValueNotFound)
		if err != nil {
			err = fmt.Errorf("failed to decode 'post /systems/{SystemUUID}/entitlements' NotFound response: %w", err)
		}
	case http.StatusInternalServerError:
		err = json.NewDecoder(body).Decode(&result.ValueInternalServerError)
		if err != nil {
			err = fmt.Errorf("failed to decode 'post /systems/{SystemUUID}/entitlements' InternalServerError response: %w", err)
		}
	default:
...
// PostSystemsSystemUUIDEntitlements performs REST operation.
func (c *Client) PostSystemsSystemUUIDEntitlements(ctx context.Context, request PostSystemsSystemUUIDEntitlementsRequest) (result PostSystemsSystemUUIDEntitlementsResponse, err error) {
	if c.InstrumentCtxFunc != nil {
		ctx = c.InstrumentCtxFunc(ctx, http.MethodPost, "/systems/{SystemUUID}/entitlements", &request)
	}
