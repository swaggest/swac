...
use Swac\Example\UsptoOAS3\Metadata\Request\GetFieldsRequest;
 ...
 */
class GetFields extends AbstractOperation
{
    /**
     ...
     */
    public function __construct(ClientInterface $client, GetFieldsRequest $request, Config $config)
    {
        $this->client = $client;
        $request->validate();
