...
use Swac\Example\FooBarOAS3\Lie\Definitions\UsecaseFindAvailableCarrotsOutput;
use Swac\Example\FooBarOAS3\Lie\Request\PostInternalFindAvailableCarrotsMilleLookRequest;
 ...
 * HTTP: POST /internal/find-available-carrots/{mille}/{look}
 */
class PostInternalFindAvailableCarrotsMilleLook extends AbstractOperation
{
    /**
     * @param ClientInterface $client
     * @param PostInternalFindAvailableCarrotsMilleLookRequest $request
     * @param Config $config
     * @throws InvalidValue
     * @throws RestException
     */
    public function __construct(ClientInterface $client, PostInternalFindAvailableCarrotsMilleLookRequest $request, Config $config)
    {
        $this->client = $client;
        $request->validate();
    ...
    /**
     * @return UsecaseFindAvailableCarrotsOutput|RestErrResponse
     * @throws RestException
     * @throws InvalidValue
     * @throws Exception
    ...
    public function getResponse()
    {
        ...
        switch ($statusCode) {
            case StatusCode::OK: $result = UsecaseFindAvailableCarrotsOutput::import($this->getJsonResponse());break;
