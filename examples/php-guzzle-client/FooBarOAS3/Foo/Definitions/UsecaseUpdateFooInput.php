...
/**
 * In: body, Name: body
 * Built from #/components/schemas/UsecaseUpdateFooInput
 * @property null|string $activateSince
 * @property null|string $activateTill
 * @property FooBarRule[]|null $barRules
 */
class UsecaseUpdateFooInput extends ClassStructure
{
    /**
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $ownerSchema->setFromRef('#/components/schemas/UsecaseUpdateFooInput');
    }
}