...
use Swac\Example\UsptoOAS3\Metadata\Request\ListDataSetsRequest;
 ...
 * HTTP: GET /
 */
class ListDataSets extends AbstractOperation
{
    /**
     ...
     */
    public function __construct(ClientInterface $client, ListDataSetsRequest $request, Config $config)
    {
        $this->client = $client;
        $request->validate();
