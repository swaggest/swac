...
// PostLieRegionsRequest is operation request value.
type PostLieRegionsRequest struct {
	Body *LieregionValue  // Body is a JSON request body.
}

// encode creates *http.Request for request data.
func (request *PostLieRegionsRequest) encode(ctx context.Context, baseURL string) (*http.Request, error) {
...
// PostLieRegionsResponse is operation response value.
type PostLieRegionsResponse struct {
	StatusCode               int
	ValueOK                  *LieregionEntity  // ValueOK is a value of 200 OK response.
...
func (result *PostLieRegionsResponse) decode(resp *http.Response) error {
	var err error
...
// PostLieRegions performs REST operation.
func (c *Client) PostLieRegions(ctx context.Context, request PostLieRegionsRequest) (result PostLieRegionsResponse, err error) {
	if c.InstrumentCtxFunc != nil {
		ctx = c.InstrumentCtxFunc(ctx, http.MethodPost, "/lie-regions", &request)
	}
