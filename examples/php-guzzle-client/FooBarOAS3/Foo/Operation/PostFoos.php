...
use Swac\Example\FooBarOAS3\Foo\Definitions\FooEntity;
use Swac\Example\FooBarOAS3\Foo\Request\PostFoosRequest;
 ...
 * HTTP: POST /foos
 */
class PostFoos extends AbstractOperation
{
    /**
     * @param ClientInterface $client
     * @param PostFoosRequest $request
     * @param Config $config
     * @throws InvalidValue
     * @throws RestException
     */
    public function __construct(ClientInterface $client, PostFoosRequest $request, Config $config)
    {
        $this->client = $client;
        $request->validate();
    ...
    /**
     * @return FooEntity|RestErrResponse
     * @throws RestException
     * @throws InvalidValue
     * @throws Exception
    ...
    public function getResponse()
    {
        ...
        switch ($statusCode) {
            case StatusCode::OK: $result = FooEntity::import($this->getJsonResponse());break;
