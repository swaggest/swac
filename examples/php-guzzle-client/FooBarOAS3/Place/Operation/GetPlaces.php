...
use Swac\Example\FooBarOAS3\Place\Request\GetPlacesRequest;
 ...
 * HTTP: GET /places
 */
class GetPlaces extends AbstractOperation
{
    /**
     ...
     */
    public function __construct(ClientInterface $client, GetPlacesRequest $request, Config $config)
    {
        $this->client = $client;
        $request->validate();
