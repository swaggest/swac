...
use Swac\Example\FooBarOAS3\Foo\Request\DeleteFoosRequest;
 ...
 * HTTP: DELETE /foos
 */
class DeleteFoos extends AbstractOperation
{
    /**
     * @param ClientInterface $client
     * @param DeleteFoosRequest $request
     * @param Config $config
     * @throws InvalidValue
     * @throws RestException
     */
    public function __construct(ClientInterface $client, DeleteFoosRequest $request, Config $config)
    {
        $this->client = $client;
        $request->validate();
