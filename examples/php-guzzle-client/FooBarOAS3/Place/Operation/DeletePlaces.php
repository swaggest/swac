...
use Swac\Example\FooBarOAS3\Place\Request\DeletePlacesRequest;
 ...
 * HTTP: DELETE /places
 */
class DeletePlaces extends AbstractOperation
{
    /**
     * @param ClientInterface $client
     * @param DeletePlacesRequest $request
     * @param Config $config
     * @throws InvalidValue
     * @throws RestException
     */
    public function __construct(ClientInterface $client, DeletePlacesRequest $request, Config $config)
    {
        $this->client = $client;
        $request->validate();
